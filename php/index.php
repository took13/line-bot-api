...
if (!empty($bot->isEvents)) {
	...
	//	$previewUrl = "https://www.picz.in.th/images/2018/06/27/4Fd0YQ.jpg";
		...
		$reply_message = $reply_message . "#g1 : show MW for GSPP1" . "\r\n";
		$reply_message = $reply_message . "#ge : show MW for Glow Energy" . "\r\n";
		$reply_message = $reply_message . "#cfb : show MW for CFB 1,2,3" . "\r\n";
		$reply_message = $reply_message . "#singleline : show GSPP2&3 single line diagram" . "\r\n";
		$reply_message = $reply_message . "#cfb3 : show CFB3 diagram" . "\r\n";
		$reply_message = $reply_message . "#daily : show daily report" . "\r\n";
		$reply_message = $reply_message . "#trend : show sample trend for Glow Energy" . "\r\n";	
	} else {
